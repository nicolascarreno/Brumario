...
export const TablaPresenciasTotales: React.FC<TablaJugadoresProps> = ({
  jugadores,
  loading,
  pagina,
  totalPaginas,
  ...
  return jugadores
    .slice()
    .sort((a, b) => (b.titular + b.suplente + b.presencias_sin_jugar) - (a.titular + a.suplente + a.presencias_sin_jugar));
}, [jugadores]);
                    ...
                    <div className='dataTabla'>
                      ...
                      <div>
                        <span className='estadistica'>
                          {jugador.titular + jugador.suplente + jugador.presencias_sin_jugar}
                        </span>
                      </div>
                    </div>
                  </div>
