  ...
  return (
    <div className="App">
      <div className="encabezado">     
        <img src={brumario} alt="brumario" height={90} width={380} style={{ marginLeft: '18px', paddingTop: 20, paddingBottom: 20 }} />
        <span className='sitio_web'>Sitio Web Oficial</span>
      </div>
      <div className="botones-container">
        <button className="boton-cuadrado" onClick={() => navigate('/jugadores')}>
          <img src={diego} alt="Diego" className="boton-imagen" width={160} height={190} />
          <span>Jugadores</span>
        </button>
        <button className="boton-cuadrado">
          <img src={escudo} alt="Escudo Brumario" className="boton-imagen" width={195} height={195} />
          <span>Partidos</span>
        </button>
      </div>  
    </div>
